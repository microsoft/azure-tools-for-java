...
(cd PluginsAndFeatures/azure-toolkit-for-intellij && ./gradlew clean buildPlugin -s -Papplicationinsights.key=${INTELLIJ_KEY} -Pidea_version=IC-2018.1 -Pdep_plugins=org.intellij.scala:2018.1.8)
